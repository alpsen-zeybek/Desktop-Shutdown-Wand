...
radio_shutdown = ttk.Radiobutton(root, text="Shutdown", value="Shutdown",style="Wild.TRadiobutton", variable=alignment_var, command=lambda: replace_ops_str()).place(x=460, y=215)
radio_restart = ttk.Radiobutton(root, text="Restart", value="Restart",style="Wild.TRadiobutton", variable=alignment_var, command=lambda: replace_ops_str()).place(x=565, y=215)
...
button_run = ttk.Button(root, text="Run", command=lambda: operator()).place(x=668, y=253, height=40)
